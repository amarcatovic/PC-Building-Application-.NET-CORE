    ...
    public static class PopulateDb
    {
        ...
        public static void SeedData(DataContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                context.Users.Add(new User() { Id= "anonymous", UserName = "Anonymous user", Email = "anonymous@buildit.com", EmailConfirmed = true, PhotoId = 1, PasswordSalt = new byte[10], PasswordHash = new byte[10]});
            }
            else
            {
